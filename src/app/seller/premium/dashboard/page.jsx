  ...
  return (
    <div className="py-4">
      ...
      >
        ...
        {/* Customize Store */}
        <button
          className="w-[301px] h-[236px] rounded-[16px] bg-[#005770] flex-shrink-0 flex flex-col items-center snap-start"
          onClick={() =>
            router.push("/seller/premium/dashboard/store")
          }
        >
          <img
        ...
        <button
          ...
          onClick={() =>
            router.push("/seller/premium/dashboard/settings")
          }
        >
          <img
      ...
      <div className="mt-[56px] space-y-[16px]">
        ...
        <div className="flex justify-center">
          <button
            ...
            onClick={() =>
              router.push("/seller/premium/dashboard/help")
            }
          >
            Visit Help Center
          </button>
