...
import { Funnel, Check, LoaderCircle } from "lucide-react";
...
export default function ProcessingOrders({ orders = [], onSelectOrder }) {
          ...
          <div className="flex items-center gap-2 text-[#005770]">
            ...
            <div className="relative w-full overflow-hidden">
              <div className="whitespace-nowrap animate-marquee text-[12px] font-inter font-medium">
                Your items are being carefully packed for delivery
              </div>
            </div>
          </div>
        </div>
